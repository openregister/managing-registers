...
RSpec.feature 'Controller Methods', type: :feature do
  ...
  scenario 'Admin can perform general actions' do
    ...
    actions.each{|action|
      expect do
        controller_methods
            .check_permissions(action, current_user: user, register_name: register.key)
      end.not_to raise_error, "admin unable to perform action #{action}"
    }
  end
  ...
  scenario 'Admin can perform team actions' do
    ...
    actions.each{|action|
      expect do
        controller_methods
            .check_permissions(action, current_user: user, team_id: team_id, team_member_id: team_member_id)
      end.not_to raise_error, "admin unable to perform action #{action}"
    }
  end
  ...
  scenario 'check_permissions REGISTER_INDEX allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_INDEX,
                             current_user: user, register_name: register.key)
  ...
  scenario 'check_permissions REGISTER_INDEX not allowed' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_INDEX,
                             current_user: user, register_name: 'ramdon')
  ...
  scenario 'check_permissions REGISTER_NEW allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_NEW,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions REGISTER_NEW not allowed' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_NEW,
                             current_user: user, register_name: 'random')
    end.to raise_error(PermissionError)
  end
  ...
  scenario 'check_permissions REGISTER_EDIT allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_EDIT,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions REGISTER_CONFIRM allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_CONFIRM,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions REGISTER_CREATE_PENDING_REVIEW allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_CREATE_PENDING_REVIEW,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions REGISTER_CREATE_AND_REVIEW allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:REGISTER_CREATE_AND_REVIEW,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions TEAM_MEMBERS_EDIT allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:TEAM_MEMBERS_EDIT,
  ...
  scenario 'check_permissions TEAM_MEMBERS_UPDATE allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:TEAM_MEMBERS_UPDATE,
                             current_user: user, team_member_id: team_member_id)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions TEAM_MEMBERS_UPDATE not allowed' do
    ...
    expect do
      controller_methods
          .check_permissions(:TEAM_MEMBERS_UPDATE,
                             current_user: user, team_member_id: 999)
    end.to raise_error(PermissionError)
  end
  ...
  scenario 'check_permissions TEAMS_SHOW allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:TEAMS_SHOW,
                             current_user: user, team_id: team_id)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions TEAMS_UPDATE allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:TEAMS_UPDATE,
                             current_user: user, team_id: team_id)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions USERS_CUSTODIANS allowed' do
    ...
    expect do
      controller_methods
          .check_permissions(:USERS_CUSTODIANS,
                             current_user: user)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions USERS_NEW allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:USERS_NEW,
                             current_user: user, role: 'custodian', team_id: team_id)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions USERS_NEW not allowed team not present' do
    ...
    expect do
      controller_methods
          .check_permissions(:USERS_NEW,
                             current_user: user, role: 'custodian')
    end.to raise_error(PermissionError)
  end
  ...
  scenario 'check_permissions CHANGE_DESTROY allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:CHANGE_DESTROY,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
  ...
  scenario 'check_permissions CHANGE_UPDATE allowed custodian' do
    ...
    expect do
      controller_methods
          .check_permissions(:CHANGE_UPDATE,
                             current_user: user, register_name: register.key)
    end.not_to raise_error
  end
